...
The model with highest accuracy was random forest (99.25 for rf vs 91.81 for knn).  I wanted to measure amount of sample error on my testing set (which is 25% of the inital training set).  Accurancy of random forest was 99.25%, so the out of sample error is 1 - 0.9925 or 0.0075.  Based on this low out of sample error, we should have very few to no misclassified on the test samples. 
